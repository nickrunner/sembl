 ...
 *
 * Dynamic enum fields become a string `enum` when their source resolved, and a
 * plain string otherwise. FieldConstraints are emitted only in the
 * `"standard"` dialect — see {@link CONSTRAINT_KEYWORDS}.
 */
